...
import CreateReservationButton from './CreateReservationButton.js';
...
class Reservation extends Component {
  ...
  render() {
    ...
    var postButton = hasSubmitted ? <h3>Thank you for reserving a date!</h3> : <CreateReservationButton addPost={this.addPost.bind(this)} />;
